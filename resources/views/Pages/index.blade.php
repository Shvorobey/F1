                    ...
                    <div id="header-sidebar" class="span6 group">
                        <div class="widget-first widget header-text-image">
                            <div class="text-image" style="text-align:left">
                                <img src="images/phone1.png" alt="Тили" />
                            </div>

                            <div class="text-content">
                                <h3>Тили</h3>
                                <p>+38 (067) 123-45-68</p>
                            </div>
                        </div>
        ...
        <div id="copyright">
            <div class="container">
                <div class="row">
                    <div class="center">
                        <p>
                            <a href="http://yithemes.com/"><img src="http://yithemes.com/cdn/images/various/footer_yith_grey.png" alt="Your Inspiration Themes" style="position:relative; top:9px; margin: -22px 5px 0 0;"></a>&nbsp;Copyright &copy;<strong style="color: black"> ALEX SHVOROBEY </strong> 2021
                        </p>
                    </div>
                </div>
            </div>
