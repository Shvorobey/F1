                ...
                <div class="span12">
                    ...
                    <div class="title">
                        ...
                        <div class="title-with-icon">
                            <h1>Редактировать конкурс {{$competition->name}}</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="content-page" class="span12 content group">
                    <form action="{{route('competition_edit', $competition->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="span12" type="text" name="name"  placeholder="Введите название конкурса" value="{{$competition->name}}">
                        </div>
                        <div class="form-group col-md-12">
                            <label style="color: gold">Описание</label>
                            <textarea class="span12 form-control tinymce-editor" name="description">{!! $competition->description !!}</textarea>
                        </div>
